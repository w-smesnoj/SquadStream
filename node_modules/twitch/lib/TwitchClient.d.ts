...
export default class TwitchClient {
     ...
     * Note that if you provide a custom `authProvider`, this method will overwrite it. In this case, you should use the constructor directly.
     */
    static withClientCredentials(clientId: string, clientSecret?: string, accessToken?: string, config?: Partial<TwitchConfig>): TwitchClient;
    /**
     ...
     */
    readonly kraken: KrakenAPIGroup;
    /**
